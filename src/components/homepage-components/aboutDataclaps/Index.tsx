...
const AboutDataclaps = () => {
  const main_heading = "Artificial Intelligence is not a matter of science fiction.";
  return ( 
    <div className="grid grid-cols-1 lg:grid-cols-2 items-center max-w-[95%] lg:max-w-[90%] mx-auto py-12">
      ...
      <div className="py-10 lg:py-20">
        ...
        <AnimatedText text={main_heading} />
